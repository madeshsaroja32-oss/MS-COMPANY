      ...
      <div className="bg-white rounded shadow overflow-x-auto">
        <table className="min-w-full">
          ...
          <tbody className="divide-y divide-gray-200">
            {records.map(rec => (
              <tr key={rec.id}>
                <td className="px-6 py-4 whitespace-nowrap">{rec.employee}</td>
                <td className="px-6 py-4 whitespace-nowrap">{rec.dept}</td>
                <td className="px-6 py-4 whitespace-nowrap">{rec.login}</td>
                <td className="px-6 py-4 whitespace-nowrap">{rec.logout}</td>
                <td className="px-6 py-4 whitespace-nowrap">{rec.hours}</td>
